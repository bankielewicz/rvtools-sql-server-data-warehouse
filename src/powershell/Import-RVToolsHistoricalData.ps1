...
.DESCRIPTION
    Processes files matching pattern: {vcenter-name}_{m_d_yyyy}.{domain.tld}.xlsx

    vcenter-name: Alphanumeric + hyphens (e.g., vCenter01, prod-vcenter, vc-east-01)
    m_d_yyyy: US date format month_day_year (flexible: 3_20_2024 or 03_20_2024)
...
.NOTES
    ...
    Examples:
    - vCenter01_6_15_2024.domain.com.xlsx (June 15, 2024)
    - prod-vcenter_12_25_2023.corp.domain.com.xlsx (December 25, 2023)
    - vc-east-01_1_1_2025.local.net.xlsx (January 1, 2025)
...
if ($fileTable.Count -eq 0) {
    Write-Host ""
    Write-Host "No files match the expected pattern: {vcenter-name}_{m_d_yyyy}.{domain.tld}.xlsx" -ForegroundColor Red
